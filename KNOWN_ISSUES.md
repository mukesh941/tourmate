...
| NB-004 | AI Service Deprecation Warning | Low (Non-blocking) | Pytest logs `FutureWarning` regarding `google.generativeai` package deprecation in favor of `google.genai`. | Gemini 2.5 Flash SDK migration scheduled for subsequent maintenance cycle; current API calls function properly. |
