...
export const getPlaces = async (params = {}, config = {}) => {
  ...
  return (await api.get(`/places?${query.toString()}`, config)).data.data;
};
export const getPlace = async (id, config = {}) => (await api.get(`/places/${id}`, config)).data.data;
