...
export default function Register() {
  ...
  return (
    ...
    >
      ...
      {/* Animated blobs */}
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-brand-500 rounded-full mix-blend-multiply filter blur-[100px] opacity-40 animate-blob"></div>
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-accent-500 rounded-full mix-blend-multiply filter blur-[100px] opacity-40 animate-blob animation-delay-2000"></div>
      ...
      <div className="relative w-full max-w-md glass bg-white/10 dark:bg-slate-900/40 border border-white/20 shadow-2xl rounded-3xl p-8 sm:p-10 z-10 animate-fade-in-up">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-display font-extrabold text-white tracking-tight mb-3">Create Account</h1>
          <p className="text-brand-100 text-sm font-light">Join TourMate AI and plan your next journey.</p>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="animate-fade-in-up-delay-1">
            <label className="block text-xs font-bold text-brand-200 uppercase tracking-widest mb-1.5" htmlFor="name">Full Name</label>
            <input
              id="name"
              required
          ...
          <div className="pt-6 text-center animate-fade-in-up-delay-2 border-t border-white/10 mt-6">
            <p className="text-sm text-gray-300 font-light">
              ...
              <Link to="/login" className="text-brand-300 font-bold hover:text-white transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-white hover:after:w-full after:transition-all after:duration-300 pb-0.5">
                Log in
              </Link>
            </p>
          </div>
