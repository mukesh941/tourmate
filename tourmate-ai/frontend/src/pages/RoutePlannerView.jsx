...
export default function RoutePlannerView() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-[calc(100vh-64px)] bg-gray-50 dark:bg-slate-900/50">
      ...
      {/* Sidebar Left */}
      <div className="w-full md:w-[420px] bg-white dark:bg-slate-800 border-r dark:border-slate-700 shadow-xl dark:shadow-none flex flex-col z-10 overflow-hidden">
        {/* Header */}
